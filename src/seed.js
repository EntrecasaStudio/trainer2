...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps', 3, '12'), ej('Abs complex', 3, '30s')]),
    ...
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps', 3, '12'), ej('Curl de bíceps en TRX', 3, '10'), ej('Ab wheel', 3, '10')]),
    ...
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps', 3, '12'), ej('Plancha con elevación alternada', 3, '10')]),
    ...
    rutinaCasa('#C09', 'Casa Pull F — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo', 3, '10'), ej('Curl martillo con kettlebell', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha', 3, '30s'), ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps', 3, '10')]),
