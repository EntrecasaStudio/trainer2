...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Remo', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C07', 'Casa Pull D — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '12')]),
