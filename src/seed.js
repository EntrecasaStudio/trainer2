...
function createRioRoutines() {
  return [
    ...
    rutinaRio('#003', 'RÍO Pull C — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas con mancuernas', 3, '10'), ej('Step-up en banco', 3, '10')]),
    ...
    rutinaRio('#004', 'RÍO Pull D — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con mancuerna', 3, '12'), ej('Banda curl biceps', 3, '1')]),
    ...
    rutinaRio('#005', 'RÍO Pull E — Espalda', 'Lean', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas con mancuernas', 3, '12'), ej('Empuje de cadera en cajon', 3, '15')]),
      circuito(3, 'ESPALDA', [ej('Dominadas abiertas', 3, 'AMRAP'), ej('TRX row', 3, '12')]),
      circuito(4, 'ESPALDA ALT', [ej('Remo con mancuerna', 3, '10'), ej('Banda pull-apart', 3, '20')]),
    ...
    rutinaRio('#006', 'RÍO Pull F — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(4, 'BÍCEPS·POSTERIOR', [ej('Curl de bíceps con mancuerna', 3, '12'), ej('Banda pull-apart', 3, '20')]),
    ...
    rutinaRio('#008', 'RÍO Pull H — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Sentadilla sumo', 3, '15'), ej('Zancadas con mancuernas', 3, '10')]),
      circuito(3, 'ESPALDA', [ej('Dominadas cerradas', 3, 'AMRAP'), ej('TRX row', 3, '15')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con mancuerna', 3, '12'), ej('Banda curl biceps', 3, '15')]),
    ...
    rutinaRio('#009', 'RÍO Press A — Hombros', 'Lean', 'press', 2, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla sumo', 3, '15'), ej('Zancadas con mancuernas', 3, '10')]),
      circuito(3, 'PECHO·HOMBROS', [ej('Flexiones', 3, '12'), ej('Dips en paralelas', 3, 'AMRAP')]),
      circuito(4, 'HOMBROS', [ej('Press militar con mancuernas', 3, '10'), ej('Vuelos laterales', 3, '15')]),
    ...
    rutinaRio('#010', 'RÍO Press B — Pecho', 'Lean', 'press', 2, [
      ...
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con mancuernas', 3, '10'), ej('Dips en paralelas', 3, 'AMRAP')]),
    ...
    rutinaRio('#011', 'RÍO Press C — Pecho', 'Lean', 'press', 1, [
      ...
      circuito(4, 'HOMBROS', [ej('Arnold press', 3, '10'), ej('TRX face pull', 3, '12')]),
    ...
    rutinaRio('#012', 'RÍO Press D — Pecho + Hombros', 'Lean', 'press', 1, [
      ...
      circuito(2, 'PIERNAS', [ej('Sentadilla con salto', 3, '10'), ej('Zancadas con mancuernas', 3, '10')]),
      circuito(3, 'PECHO·HOMBROS', [ej('Flexiones explosivas', 3, '8'), ej('Press militar con mancuernas', 3, '10')]),
    ...
    rutinaRio('#014', 'RÍO Press F — Pecho + Hombros', 'Lean', 'press', 1, [
      ...
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con mancuernas', 3, '10'), ej('Extensión de triceps sobre cabeza', 3, '12')]),
    ...
    rutinaRio('#018', 'RÍO Pull C — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Patada de glúteo con tobillera', 3, '15'), ej('Zancadas con mancuernas', 3, '10')]),
    ...
    rutinaRio('#022', 'RÍO Pull G — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas con mancuernas', 3, '10'), ej('Empuje de cadera en cajon', 3, '15')]),
    ...
    rutinaRio('#024', 'RÍO Press A — Nat', 'Nat', 'press', 1, [
      ...
      circuito(4, 'HOMBROS', [ej('Press militar con mancuernas', 3, '12'), ej('Vuelos laterales', 3, '15')]),
    ...
    rutinaRio('#025', 'RÍO Press B — Nat', 'Nat', 'press', 1, [
      ...
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con mancuernas', 3, '12'), ej('Fondos en banco', 3, '15')]),
    ...
    rutinaRio('#027', 'RÍO Press D — Nat', 'Nat', 'press', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda dislocates', 2, '15'), ej('Rotación torácica', 2, '10')]),
      circuito(2, 'PIERNAS', [ej('Sentadilla con salto', 3, '8'), ej('Zancadas con mancuernas', 3, '10')]),
      circuito(3, 'PECHO·HOMBROS', [ej('Flexiones', 3, '10'), ej('Press militar con mancuernas', 3, '12')]),
      circuito(4, 'TRÍCEPS', [ej('Fondos en banco', 3, '15'), ej('Extensión de triceps sobre cabeza', 3, '15')]),
    ...
    rutinaRio('#029', 'RÍO Press F — Nat', 'Nat', 'press', 2, [
      ...
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con mancuernas', 3, '12'), ej('Extensión de triceps sobre cabeza', 3, '12')]),
      circuito(5, 'CORE+CARDIO', [ej('Ab wheel', 3, '8'), ej('Bear crawl', 4, '8m'), ej('Pasadas de velocidad', 4, '15m')]),
    ]),
    // RÍO Press G — Nat
...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C01', 'Casa Press A — Lean', 'Lean', 'press', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 2, '15'), ej('Banda dislocates', 2, '10')]),
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla goblet con kettlebell 12k', 2, '12'), ej('Zancadas con chaleco de peso', 2, '10')]),
      circuito(3, 'PECHO', [ej('Flexiones con chaleco', 2, '12'), ej('TRX chest press', 2, '12')]),
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell 12k', 2, '10'), ej('Fondos en banco con chaleco', 2, '12')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '10'), ej('Plancha con chaleco', 2, '30s')]),
      circuito(6, 'HIIT', [ej('Mountain climbers', 3, '20'), ej('Burpees', 3, '8')]),
    ]),
    rutinaCasa('#C02', 'Casa Press B — Lean', 'Lean', 'press', 2, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Zancadas con chaleco de peso', 2, '10'), ej('Sentadilla sumo con kettlebell 12k', 2, '12')]),
      circuito(3, 'PECHO·HOMBROS', [ej('Flexiones explosivas', 2, '8'), ej('Banda press de pecho', 2, '15')]),
      circuito(4, 'HOMBROS', [ej('Arnold press con kettlebell 12k', 2, '10'), ej('Vuelos laterales con banda', 2, '12')]),
      circuito(5, 'CORE', [ej('Hollow body con plato rucking', 2, '30s'), ej('Plancha con elevación alternada', 2, '10')]),
      circuito(6, 'HIIT', [ej('Burpees con chaleco', 3, '8'), ej('Jumping jacks', 3, '30')]),
    ]),
    rutinaCasa('#C03', 'Casa Press C — Lean', 'Lean', 'press', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 2, '15'), ej('Rotación de hombros con banda', 2, '10')]),
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla goblet con kettlebell 12k', 2, '10'), ej('Sentadilla con salto con chaleco', 2, '8')]),
      circuito(3, 'PECHO', [ej('TRX chest press', 2, '12'), ej('Flexiones diamante', 2, '10')]),
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell 12k', 2, '10'), ej('Extensión de tríceps con banda', 2, '15')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '10'), ej('Plancha con chaleco', 2, '30s')]),
      circuito(6, 'HIIT', [ej('Burpees con chaleco', 3, '8'), ej('Mountain climbers', 3, '20')]),
    ]),

    // ── LEAN PULL ──────────────────────────────────────────
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda lateral walk', 2, '15'), ej('Rotación torácica', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Sentadilla búlgara con kettlebell 12k', 2, '10'), ej('Peso muerto rumano con kettlebell 12k', 2, '10')]),
      circuito(3, 'ESPALDA', [ej('Dominadas australianas con chaleco', 2, '12'), ej('TRX row', 2, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con kettlebell 12k', 2, '12'), ej('Banda curl biceps', 2, '15')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '10'), ej('Hollow body con plato rucking', 2, '30s')]),
      circuito(6, 'HIIT', [ej('Bear crawl con chaleco', 4, '8m'), ej('Pasadas de velocidad', 4, '20m')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 2, '15'), ej('Movilidad de cadera', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Peso muerto rumano con kettlebell 12k', 2, '10'), ej('Zancadas con chaleco de peso', 2, '10')]),
      circuito(3, 'ESPALDA', [ej('TRX row', 2, '12'), ej('Remo con kettlebell 12k', 2, '10')]),
      circuito(4, 'ESPALDA ALT', [ej('Dominadas australianas con chaleco', 2, '12'), ej('Banda pull-apart', 2, '20')]),
      circuito(5, 'CORE', [ej('Plancha lateral con chaleco', 2, '20s'), ej('Ab wheel', 2, '10')]),
      circuito(6, 'HIIT', [ej('Jumping jacks con chaleco', 3, '30'), ej('Mountain climbers', 3, '20')]),
    ]),
    rutinaCasa('#C06', 'Casa Pull C — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda face pull', 2, '15'), ej('Hip 90/90 mobility', 2, '8')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Empuje de cadera con plato rucking', 2, '12'), ej('Sentadilla búlgara con kettlebell 12k', 2, '10')]),
      circuito(3, 'ESPALDA', [ej('Remo con kettlebell 12k', 2, '10'), ej('Dominadas australianas con chaleco', 2, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl martillo con kettlebell 12k', 2, '12'), ej('Banda curl biceps', 2, '15')]),
      circuito(5, 'CORE', [ej('Dead bug', 2, '12'), ej('Ab wheel', 2, '10')]),
      circuito(6, 'HIIT', [ej('Mountain climbers con chaleco', 3, '20'), ej('Pasadas de velocidad', 4, '20m')]),
    ]),

    // ── NAT PRESS ──────────────────────────────────────────
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Activación glúteo con loop band', 2, '15'), ej('Rotación de hombros con banda', 2, '15')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Empuje de cadera con plato rucking', 2, '15'), ej('Sentadilla goblet con kettlebell 8k', 2, '12')]),
      circuito(3, 'PECHO', [ej('TRX chest press', 2, '12'), ej('Flexiones inclinadas', 2, '10')]),
      circuito(4, 'HOMBROS', [ej('Press militar con kettlebell 8k', 2, '10'), ej('Vuelos laterales con banda', 2, '12')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '8'), ej('Plancha', 2, '25s')]),
      circuito(6, 'HIIT', [ej('Jumping jacks', 3, '25'), ej('Mountain climbers', 3, '15')]),
    ]),
    rutinaCasa('#C02', 'Casa Press B — Nat', 'Nat', 'press', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda lateral walk', 2, '15'), ej('Movilidad de hombros', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Patada de glúteo con tobillera 4k', 2, '15'), ej('Zancadas con kettlebell 8k', 2, '10')]),
      circuito(3, 'PECHO·HOMBROS', [ej('Banda press de pecho', 2, '15'), ej('Flexiones', 2, '10')]),
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Arnold press con kettlebell 8k', 2, '10'), ej('Fondos en banco', 2, '12')]),
      circuito(5, 'CORE', [ej('Hollow body con plato rucking', 2, '25s'), ej('Ab wheel', 2, '8')]),
      circuito(6, 'HIIT', [ej('Burpees', 3, '6'), ej('Jumping jacks', 3, '25')]),
    ]),
    rutinaCasa('#C03', 'Casa Press C — Nat', 'Nat', 'press', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Activación glúteo con loop band', 2, '15'), ej('Banda dislocates', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Empuje de cadera con plato rucking', 2, '15'), ej('Sentadilla sumo con kettlebell 8k', 2, '12')]),
      circuito(3, 'PECHO', [ej('Flexiones', 2, '10'), ej('TRX chest press', 2, '12')]),
      circuito(4, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell 8k', 2, '10'), ej('Extensión de tríceps con banda', 2, '15')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '8'), ej('Plancha con elevación alternada', 2, '8')]),
      circuito(6, 'HIIT', [ej('Mountain climbers', 3, '20'), ej('Burpees', 3, '6')]),
    ]),

    // ── NAT PULL ───────────────────────────────────────────
    rutinaCasa('#C04', 'Casa Pull A — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Activación glúteo con loop band', 2, '15'), ej('Rotación torácica', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Sentadilla búlgara con kettlebell 8k', 2, '12'), ej('Empuje de cadera con plato rucking', 2, '15')]),
      circuito(3, 'ESPALDA', [ej('TRX row', 2, '15'), ej('Dominadas australianas', 2, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con kettlebell 8k', 2, '12'), ej('Banda curl biceps', 2, '15')]),
      circuito(5, 'CORE', [ej('Ab wheel', 2, '8'), ej('Dead bug', 2, '10')]),
      circuito(6, 'HIIT', [ej('Jumping jacks', 3, '25'), ej('Mountain climbers', 3, '15')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 2, '15'), ej('Movilidad de cadera', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Patada de glúteo con tobillera 4k', 2, '20'), ej('Peso muerto rumano con kettlebell 8k', 2, '10')]),
      circuito(3, 'ESPALDA', [ej('TRX row', 2, '15'), ej('Remo con kettlebell 8k', 2, '10')]),
      circuito(4, 'ESPALDA ALT', [ej('Banda pull-apart', 2, '20'), ej('Dominadas australianas', 2, '10')]),
      circuito(5, 'CORE', [ej('Plancha con elevación alternada', 2, '8'), ej('Ab wheel', 2, '8')]),
      circuito(6, 'HIIT', [ej('Mountain climbers', 3, '20'), ej('Jumping jacks', 3, '25')]),
    ]),
    rutinaCasa('#C06', 'Casa Pull C — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda lateral walk', 2, '15'), ej('Cat-cow', 2, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Loop band abducción parada', 2, '15'), ej('Sentadilla goblet con kettlebell 8k', 2, '12')]),
      circuito(3, 'ESPALDA', [ej('Dominadas australianas', 2, '15'), ej('TRX row', 2, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con kettlebell 8k', 2, '12'), ej('Curl martillo con kettlebell 8k', 2, '12')]),
      circuito(5, 'CORE', [ej('Hollow body', 2, '25s'), ej('Ab wheel', 2, '8')]),
      circuito(6, 'HIIT', [ej('Pasadas de velocidad', 4, '15m'), ej('Mountain climbers', 3, '20')]),
    ]),
  ];
}
