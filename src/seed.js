...
function createLeanRoutines() {
  return [
    ...
    rutina('#002', 'Press B — Pecho + Hombros', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS · CORE', [ej('Zancadas'), ej('Sentadilla sumo'), ej('Dead bug', 2, '30s')]),
    ...
    rutina('#004', 'Press D — Pecho + Brazos', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS · CORE', [ej('Zancadas'), ej('Sentadilla sumo'), ej('Espinales con disco', 2, '30s')]),
    ...
    rutina('#006', 'Pull A — Espalda + Hombros', 'Lean', 'pull', 1, [
      ...
      circuito(3, 'ESPALDA ALT', [ej('Remo'), ej('Jalón al pecho')]),
    ...
    rutina('#008', 'Pull C — Espalda + Hombros', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA ALT', [ej('Remo en maquina'), ej('Remo')]),
    ...
    rutina('#010', 'Pull E — Espalda + Hombros', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS · CORE', [ej('Peso muerto con barra'), ej('Sentadilla con barra'), ej('Complex', 2, '30s')]),
      circuito(2, 'ESPALDA', [ej('Dominadas abiertas'), ej('Remo en maquina')]),
      circuito(3, 'ESPALDA ALT', [ej('Jalón al pecho'), ej('Remo')]),
      circuito(4, 'HOMBROS', [ej('Face pulls'), ej('Elevaciones de hombro adelante')]),
      circuito(5, 'BRAZOS', [ej('Bíceps curl en TRX'), ej('Tríceps alto en TRX')]),
      circuito(6, 'HIIT', [ej('Pasadas de velocidad', 5, 1)]),
    ]),
    ...
    rutina('#022', 'Press G — Hombros + Pecho', 'Lean', 'press', 1, [
      ...
      circuito(2, 'HOMBROS', [ej('Arnold press'), ej('Elevaciones de hombro hacia arriba')]),
    ...
    rutina('#023', 'Pull F — Espalda + Brazos', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'ESPALDA', [ej('Remo'), ej('Remo en maquina')]),
    ...
    rutina('#024', 'Pull G — Espalda + Hombros', 'Lean', 'pull', 1, [
      ...
      circuito(2, 'ESPALDA', [ej('Remo'), ej('Dominadas abiertas')]),
...
function createNatRoutines() {
  return [
    ...
    rutina('#012', 'Press B — Pecho + Glúteos', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS · CORE', [ej('Sentadilla sumo'), ej('Zancadas'), ej('Dead bug', 2, '30s')]),
      circuito(2, 'PECHO', [ej('Press de banca con barra'), ej('Pecho con polea doble')]),
    ...
    rutina('#014', 'Press D — Pecho + Glúteos', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS · CORE', [ej('Sentadilla sumo'), ej('Zancadas'), ej('Plancha en codos', 2, '30s')]),
    ...
    rutina('#019', 'Pull D — Espalda + Glúteos', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS · CORE', [ej('Sentadilla sumo'), ej('Zancadas'), ej('Espinales con disco', 2, '30s')]),
      circuito(2, 'ESPALDA', [ej('Remo en maquina separado'), ej('Remo')]),
...
function createRioRoutines() {
  return [
    ...
    rutinaRio('#002', 'RÍO Pull B — Espalda', 'Lean', 'pull', 1, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('TRX chest press', 3, '12'), ej('Extensión de triceps sobre cabeza', 3, '10')]),
    ...
    rutinaRio('#003', 'RÍO Pull C — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas', 3, '10'), ej('Peso muerto a una pierna', 3, '10')]),
    ...
    rutinaRio('#004', 'RÍO Pull D — Espalda', 'Lean', 'pull', 2, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('Flexiones declinadas', 3, '12'), ej('Extensión de triceps sobre cabeza', 3, '10')]),
    ...
    rutinaRio('#005', 'RÍO Pull E — Espalda', 'Lean', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas', 3, '12'), ej('Empuje de cadera en piso con peso', 3, '15')]),
      circuito(3, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12')]),
    ...
    rutinaRio('#006', 'RÍO Pull F — Espalda', 'Lean', 'pull', 2, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('Flexiones explosivas', 3, '8'), ej('Extensión de triceps sobre cabeza', 3, '10')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Step up', 3, '10'), ej('Empuje de cadera en piso con peso', 3, '12')]),
    ...
    rutinaRio('#007', 'RÍO Pull G — Espalda', 'Lean', 'pull', 1, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('Flexiones', 3, '12'), ej('Extensión de triceps sobre cabeza', 3, '10')]),
    ...
    rutinaRio('#008', 'RÍO Pull H — Espalda', 'Lean', 'pull', 2, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('Flexiones diamante', 3, '10'), ej('Fondos en banco', 3, '12')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Peso muerto a una pierna', 3, '10'), ej('Zancadas', 3, '10')]),
    ...
    rutinaRio('#009', 'RÍO Press A — Hombros', 'Lean', 'press', 2, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla sumo', 3, '15'), ej('Zancadas', 3, '10')]),
    ...
    rutinaRio('#011', 'RÍO Press C — Pecho', 'Lean', 'press', 1, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla búlgara', 3, '10'), ej('Step up', 3, '10')]),
      circuito(3, 'PECHO', [ej('Flexiones', 3, '12'), ej('TRX chest press', 3, '12')]),
      circuito(4, 'HOMBROS', [ej('Arnold press', 3, '10'), ej('Vuelos laterales', 3, '15')]),
    ...
    rutinaRio('#012', 'RÍO Press D — Pecho + Hombros', 'Lean', 'press', 1, [
      ...
      circuito(2, 'PIERNAS', [ej('Sentadilla con salto', 3, '10'), ej('Zancadas', 3, '10')]),
    ...
    rutinaRio('#013', 'RÍO Press E — Pecho', 'Lean', 'press', 2, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla sumo', 3, '15'), ej('Step up', 3, '10')]),
      circuito(3, 'PECHO', [ej('Flexiones', 3, '12'), ej('Flexiones declinadas', 3, '15')]),
      circuito(4, 'HOMBROS', [ej('Press militar', 3, '10'), ej('Vuelos laterales', 3, '15')]),
    ...
    rutinaRio('#016', 'RÍO Pull A — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Empuje de cadera en piso con peso', 3, '15'), ej('Standing weighted hip abduction', 3, '12')]),
    ...
    rutinaRio('#022', 'RÍO Pull G — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas', 3, '10'), ej('Empuje de cadera en piso con peso', 3, '15')]),
    ...
    rutinaRio('#023', 'RÍO Pull H — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Standing weighted hip abduction', 3, '12'), ej('Empuje de cadera en piso con peso', 3, '15')]),
    ...
    rutinaRio('#024', 'RÍO Press A — Nat', 'Nat', 'press', 1, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Sentadilla sumo', 3, '15'), ej('Zancadas', 3, '10')]),
      circuito(3, 'PECHO', [ej('Flexiones declinadas', 3, '12'), ej('TRX chest press', 3, '12')]),
    ...
    rutinaRio('#025', 'RÍO Press B — Nat', 'Nat', 'press', 1, [
      ...
      circuito(2, 'PIERNAS·CUÁDRICEPS', [ej('Step up', 3, '10'), ej('Sentadilla sumo', 3, '12')]),
    ...
    rutinaRio('#027', 'RÍO Press D — Nat', 'Nat', 'press', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Split squat pulses', 3, '12'), ej('Empuje de cadera en piso con peso', 3, '15')]),
    ...
    rutinaRio('#030', 'RÍO Press G — Nat', 'Nat', 'press', 1, [
      ...
      circuito(3, 'PECHO', [ej('Flexiones', 3, '10'), ej('Flexiones declinadas', 3, '12')]),
      circuito(4, 'HOMBROS', [ej('Arnold press', 3, '10'), ej('Vuelos laterales', 3, '15')]),
...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C01', 'Casa Press A — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 2, '12'), ej('Zancadas', 2, '10'), ej('TRX row', 2, '12')]),
      circuito(2, 'PECHO', [ej('Floor press', 2, '10'), ej('Flexiones', 2, '12'), ej('TRX chest press', 2, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar', 2, '10'), ej('Fondos en banco', 2, '12'), ej('Vuelos laterales', 2, '12')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 2, '10'), ej('Plancha oscilante en codos', 2, '30s'), ej('Bíceps curl en equilibrio', 2, '10')]),
    ...
    rutinaCasa('#C02', 'Casa Press B — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Caminata de granjero', 2, '12'), ej('Pistol squat', 2, '8'), ej('Sentadilla búlgara', 2, '10')]),
      circuito(2, 'PECHO', [ej('Flexiones explosivas', 2, '8'), ej('TRX archer press', 2, '10'), ej('TRX chest press', 2, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Arnold press', 2, '10'), ej('Extensión de triceps sobre cabeza', 2, '10'), ej('Elevaciones de hombro adelante', 2, '12')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Toe touch con disco', 2, '12'), ej('Plancha commando', 2, '10'), ej('Bíceps curl martillo', 2, '10')]),
      circuito(5, 'HIIT', [ej('Caminata a plancha', 4, '8m'), ej('Tuck jumps', 4, '8'), ej('Mountain climbers', 4, '20')]),
    ]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Peso muerto a una pierna', 2, '10'), ej('Remo alto en TRX', 2, '12'), ej('Pistol squat', 2, '12')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Crunch oblicuo a una pierna', 2, '12'), ej('Toe touch con disco', 2, '30s'), ej('Bíceps curl concentrado', 2, '10')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '8'), ej('Jumping jacks', 4, '30'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      ...
      circuito(2, 'PECHO', [ej('Flexiones diamante', 2, '10'), ej('TRX archer press', 2, '10'), ej('Banda press de pecho', 2, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar', 2, '10'), ej('French press en puente de glúteos', 2, '12'), ej('Zancada cruzada con vuelo lateral', 2, '10')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 2, '10'), ej('Caminata a plancha', 2, '8'), ej('Bíceps curl', 2, '12')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 4, '8'), ej('Mountain climbers', 4, '20'), ej('Caminata a plancha', 4, '8')]),
    ]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 4, '10'), ej('Bear crawl', 4, '8m'), ej('Saltos laterales', 4, '20')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Step up', 2, '12'), ej('Plancha lateral dinámica', 2, '25s'), ej('Sentadilla sumo', 2, '12')]),
      circuito(2, 'ESPALDA', [ej('TRX row', 2, '12'), ej('TRX power pull', 2, '8'), ej('Remo alto en TRX', 2, '20')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Bíceps curl en equilibrio', 2, '12'), ej('Oscilaciones laterales con disco', 2, '10'), ej('Bíceps curl con banda', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Tríceps alto en TRX a un brazo', 2, '8'), ej('Flexiones declinadas', 2, '12'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '8'), ej('Jumping jacks', 4, '30'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C06', 'Casa Pull C — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(2, 'ESPALDA', [ej('TRX row', 2, '12'), ej('TRX face pull', 2, '15'), ej('Dominadas australianas', 2, '12')]),
      ...
      circuito(5, 'HIIT', [ej('Mountain climbers', 4, '20'), ej('Tuck jumps', 4, '8'), ej('Caminata a plancha', 4, '8')]),
    ]),
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla búlgara', 2, '10'), ej('Sentadilla sumo', 2, '15'), ej('Flexión con toque de hombro', 2, '12')]),
      circuito(2, 'ESPALDA', [ej('TRX row', 2, '12'), ej('Remo', 2, '10'), ej('Banda pull-apart', 2, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Bíceps curl en equilibrio', 2, '12'), ej('Bird-dog', 2, '10'), ej('Bíceps curl con banda', 2, '12')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Fondos en banco', 2, '12'), ej('TRX chest press', 2, '12'), ej('Extensión de triceps sobre cabeza', 2, '15')]),
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 4, '10'), ej('Bear crawl', 4, '8m'), ej('Saltos laterales', 4, '20')]),
    ]),
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Zancadas', 2, '15'), ej('Peso muerto a una pierna', 2, '10'), ej('Copenhague', 2, '8')]),
      circuito(2, 'ESPALDA', [ej('Dominadas australianas', 2, '12'), ej('Remo alto en TRX', 2, '12'), ej('Remo', 2, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Bíceps curl en TRX', 2, '10'), ej('Plancha estrella con peso', 2, '6'), ej('Bíceps curl en equilibrio', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Extensión de tríceps con banda', 2, '12'), ej('Flexiones explosivas', 2, '12'), ej('French press', 2, '10')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '8'), ej('Jumping jacks', 4, '30'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'ESPALDA', [ej('TRX row', 2, '12'), ej('TRX power pull', 2, '8'), ej('TRX face pull', 2, '10')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Bíceps curl martillo', 2, '10'), ej('Bird-dog', 2, '10'), ej('Bíceps curl concentrado', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Flexiones', 2, '8'), ej('Tríceps alto en TRX a un brazo', 2, '8'), ej('Banda press de pecho a un brazo', 2, '12')]),
    ...
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sumo squat to calf raise', 2, '12'), ej('Hip thrust a una pierna', 2, '10'), ej('Peso muerto dividido', 2, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Floor press', 2, '10'), ej('Press militar', 2, '10'), ej('Flexiones declinadas', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Fondos en banco', 2, '12'), ej('Vuelos laterales', 2, '12'), ej('French press', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Ab wheel', 2, '8'), ej('Plancha', 2, '25s'), ej('Empuje de cadera en piso con peso', 2, '15')]),
      circuito(5, 'HIIT', [ej('Jumping jacks', 4, '25'), ej('Mountain climbers', 4, '15'), ej('Burpees', 4, '6')]),
    ]),
    rutinaCasa('#C02', 'Casa Press B — Nat', 'Nat', 'press', 2, [
      ...
      circuito(2, 'PECHO·HOMBROS', [ej('TRX chest press', 2, '12'), ej('Arnold press', 2, '10'), ej('Flexiones', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Extensión de triceps sobre cabeza', 2, '10'), ej('Peso muerto sumo con elevación frontal', 2, '10'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Toe touch con descenso de piernas', 2, '12'), ej('Dead bug', 2, '10'), ej('Standing weighted hip abduction', 2, '15')]),
      circuito(5, 'HIIT', [ej('Caminata a plancha', 4, '8'), ej('Tuck jumps', 4, '8'), ej('Mountain climbers', 4, '15')]),
    ]),
    rutinaCasa('#C03', 'Casa Press C — Nat', 'Nat', 'press', 1, [
      ...
      circuito(4, 'CORE·PIERNAS', [ej('Plancha estrella con peso', 2, '8'), ej('Hollow body', 2, '25s'), ej('Hip thrust a una pierna', 2, '12')]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sentadilla búlgara', 2, '10'), ej('Abducción con pausa', 2, '10'), ej('Zancadas', 2, '10')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones declinadas', 2, '12'), ej('Press militar', 2, '10'), ej('TRX archer press', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Extensión de triceps sobre cabeza', 2, '10'), ej('Zancada cruzada con vuelo lateral', 2, '10'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Plancha estrella con peso', 2, '6'), ej('Bird-dog', 2, '10'), ej('Loop band abducción parada', 2, '15')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '6'), ej('Jumping jacks', 4, '25'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C09', 'Casa Press E — Nat', 'Nat', 'press', 2, [
      ...
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones diamante', 2, '10'), ej('Arnold press', 2, '10'), ej('TRX chest press', 2, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('TRX archer press', 2, '12'), ej('Vuelos laterales', 2, '12'), ej('Extensión de tríceps con banda', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Ab wheel', 2, '8'), ej('Plancha', 2, '25s'), ej('Patada de glúteo con tobillera', 2, '12')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 4, '8'), ej('Mountain climbers', 4, '15'), ej('Caminata a plancha', 4, '8')]),
    ]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto a una pierna', 2, '10'), ej('Empuje de cadera', 2, '15'), ej('Renegade row', 2, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 2, '15'), ej('Bíceps curl', 2, '12'), ej('TRX face pull', 2, '15')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Plancha estrella con peso', 2, '6'), ej('Banda pull-apart', 2, '20'), ej('Tríceps alto en TRX', 2, '12')]),
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 4, '8'), ej('Bear crawl', 4, '8m'), ej('Saltos laterales', 4, '20')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sumo squat to RDL', 2, '10'), ej('Calf raises', 2, '15'), ej('Sentadilla búlgara', 2, '10')]),
      circuito(2, 'PIERNAS·CORE', [ej('Hip thrust a una pierna', 2, '12'), ej('Sentadilla goblet', 2, '12'), ej('Abs complex', 2, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Remo', 2, '10'), ej('Bíceps curl martillo', 2, '10'), ej('TRX face pull', 2, '12')]),
    ...
    rutinaCasa('#C06', 'Casa Pull C — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·CORE', [ej('Zancadas', 2, '10'), ej('Elevated side leg lifts', 2, '12'), ej('Dead bug', 2, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 2, '15'), ej('Bíceps curl con banda', 2, '12'), ej('TRX power pull', 2, '10')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Ab wheel', 2, '8'), ej('Extensión de tríceps con banda', 2, '15'), ej('Bíceps curl en equilibrio', 2, '10')]),
      circuito(5, 'HIIT', [ej('Mountain climbers', 4, '15'), ej('Tuck jumps', 4, '8'), ej('Caminata a plancha', 4, '8')]),
    ]),
    rutinaCasa('#C07', 'Casa Pull D — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sumo squat to RDL', 2, '10'), ej('Copenhague', 2, '15'), ej('Extensión de cadera en 4 puntos', 2, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Empuje de cadera en piso con peso', 2, '15'), ej('Sentadilla sumo', 2, '12'), ej('Plancha con arrastre', 2, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Remo alto en TRX', 2, '12'), ej('Bíceps curl en TRX', 2, '10'), ej('TRX face pull', 2, '15')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Hollow body', 2, '25s'), ej('Fondos en banco', 2, '12'), ej('Remo alto en TRX', 2, '12')]),
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 4, '8'), ej('Bear crawl', 4, '8m'), ej('Saltos laterales', 4, '20')]),
    ]),
    rutinaCasa('#C08', 'Casa Pull E — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto a una pierna', 2, '10'), ej('Empuje de cadera en cajon', 2, '12'), ej('Abs complex', 2, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 2, '12'), ej('Bíceps curl concentrado', 2, '10'), ej('Dominadas australianas', 2, '12')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Flexión con toque de hombro', 2, '10'), ej('Tríceps alto en TRX a un brazo', 2, '8'), ej('Remo alto en TRX', 2, '20')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '6'), ej('Jumping jacks', 4, '25'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C09', 'Casa Pull F — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Copenhague', 2, '15'), ej('Sentadilla sumo', 2, '15'), ej('Sentadilla búlgara', 2, '10')]),
      circuito(2, 'PIERNAS·CORE', [ej('Hip thrust a una pierna', 2, '12'), ej('Standing weighted hip abduction', 2, '12'), ej('Bird-dog', 2, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX power pull', 2, '10'), ej('Bíceps curl martillo', 2, '10'), ej('Remo', 2, '10')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Peso muerto a una pierna', 2, '8'), ej('French press en puente de glúteos', 2, '12'), ej('Bíceps curl en equilibrio', 2, '12')]),
      circuito(5, 'HIIT', [ej('Caminata a plancha', 4, '8'), ej('Tuck jumps', 4, '8'), ej('Estocada con salto', 4, '8')]),
    ]),
    ...
    rutinaCasa('#C19', 'Casa Press J — Lean', 'Lean', 'press', 1, [
      ...
      circuito(5, 'HIIT', [ej('Step-up rápidos alternados', 4, '20'), ej('Patinadores', 4, '20'), ej('Rodillas altas', 4, '30')]),
    ]),

    // ── LEAN PULL G-J ─────────────────────────────────────────
    rutinaCasa('#C14', 'Casa Pull G — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Zancada con rotación', 2, '10'), ej('Sentadilla búlgara', 2, '10'), ej('Copenhague', 2, '15')]),
      circuito(2, 'ESPALDA', [ej('Peso muerto rumano con remo', 2, '10'), ej('Dominadas australianas', 2, '12'), ej('Banda pull-apart', 2, '20')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Bíceps curl en TRX', 2, '10'), ej('Plancha commando', 2, '10'), ej('Bíceps curl en equilibrio', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Fondos en banco', 2, '12'), ej('Flexiones diamante', 2, '10'), ej('French press', 2, '10')]),
      circuito(5, 'HIIT', [ej('Saltos laterales', 4, '20'), ej('Sentadilla con salto', 4, '10'), ej('Bear crawl', 4, '8m')]),
    ]),
    rutinaCasa('#C16', 'Casa Pull H — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla con press Pallof', 2, '10'), ej('Peso muerto a una pierna', 2, '10'), ej('Elevación de talones a una pierna', 2, '15')]),
      circuito(2, 'ESPALDA', [ej('Remo', 2, '10'), ej('TRX row', 2, '12'), ej('TRX power pull', 2, '8')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Zancada reversa con curl martillo', 2, '10'), ej('Bird-dog', 2, '10'), ej('Bíceps curl concentrado', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Flexiones', 2, '12'), ej('TRX pec press', 2, '10'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '8'), ej('Jumping jacks', 4, '30'), ej('Mountain climbers', 4, '20')]),
    ]),
    rutinaCasa('#C18', 'Casa Pull I — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Levantamiento turco', 2, '5'), ej('Step up', 2, '12'), ej('Copenhague', 2, '15')]),
      circuito(2, 'ESPALDA', [ej('Dominadas australianas', 2, '12'), ej('TRX face pull', 2, '15'), ej('Banda pull-apart', 2, '20')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Caminata de maleta', 2, '20m'), ej('Pallof press', 2, '10'), ej('Bíceps curl martillo', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('TRX chest press', 2, '12'), ej('Flexiones declinadas', 2, '12'), ej('French press en puente de glúteos', 2, '12')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 4, '8'), ej('Caminata a plancha', 4, '8'), ej('Estocada con salto', 4, '8')]),
    ]),
    rutinaCasa('#C20', 'Casa Pull J — Lean', 'Lean', 'pull', 2, [
    ...
    // ── NAT PRESS H-J ─────────────────────────────────────────
    rutinaCasa('#C13', 'Casa Press H — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sentadilla goblet con press', 2, '10'), ej('Calf raises', 2, '15'), ej('Hip thrust a una pierna', 2, '10')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Floor press', 2, '10'), ej('Press militar', 2, '10'), ej('Flexiones declinadas', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Zancada reversa con press a un brazo', 2, '8'), ej('Vuelos laterales', 2, '12'), ej('Fondos en banco', 2, '12')]),
      circuito(4, 'CORE·PIERNAS', [ej('Plancha lateral', 2, '25s'), ej('Bird-dog', 2, '10'), ej('Loop band abducción parada', 2, '15')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '6'), ej('Sentadilla con salto', 4, '8'), ej('Bear crawl', 4, '8m')]),
    ]),
    rutinaCasa('#C15', 'Casa Press I — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Step-up con rodilla al pecho', 2, '10'), ej('Sentadilla búlgara', 2, '10'), ej('Abducción con pausa', 2, '10')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Thruster con kettlebell', 2, '8'), ej('Banda press de pecho', 2, '15'), ej('Vuelo lateral inclinado', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Extensión de triceps sobre cabeza', 2, '10'), ej('Elevaciones de hombro adelante', 2, '12'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Plancha estrella con peso', 2, '6'), ej('Dead bug', 2, '12'), ej('Standing weighted hip abduction', 2, '15')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 4, '8'), ej('Mountain climbers', 4, '15'), ej('Saltos laterales', 4, '20')]),
    ]),
    rutinaCasa('#C17', 'Casa Press J — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Zancada con rotación', 2, '10'), ej('Sentadilla sumo', 2, '12'), ej('Patada de glúteo con tobillera', 2, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Sentadilla goblet con press', 2, '10'), ej('TRX archer press', 2, '10'), ej('Flexiones', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Zancada cruzada con vuelo lateral', 2, '10'), ej('French press', 2, '10'), ej('Extensión de tríceps con banda', 2, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Caminata con brazo arriba', 2, '20m'), ej('Plancha lateral', 2, '25s'), ej('Copenhague', 2, '15')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 4, '8'), ej('Estocada con salto', 4, '8'), ej('Caminata a plancha', 4, '8')]),
    ]),

    // ── NAT PULL H-J ──────────────────────────────────────────
    rutinaCasa('#C14', 'Casa Pull H — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Peso muerto a una pierna con remo', 2, '10'), ej('Elevated side reaches', 2, '12'), ej('Plié dips', 2, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Sentadilla con press Pallof', 2, '10'), ej('Hip thrust a una pierna', 2, '12'), ej('Empuje de cadera en piso con peso', 2, '15')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 2, '15'), ej('Bíceps curl martillo', 2, '10'), ej('Dominadas australianas', 2, '12')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Pallof press', 2, '10'), ej('French press en puente de glúteos', 2, '12'), ej('Banda pull-apart', 2, '20')]),
      circuito(5, 'HIIT', [ej('Jumping jacks', 4, '25'), ej('Estocada con salto', 4, '8'), ej('Caminata a plancha', 4, '8')]),
    ]),
    rutinaCasa('#C16', 'Casa Pull I — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Zancada reversa con curl martillo', 2, '10'), ej('Sumo squat to RDL', 2, '10'), ej('Calf raises', 2, '15')]),
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto rumano con remo', 2, '10'), ej('Hip thrust a una pierna', 2, '10'), ej('Hollow body', 2, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX power pull', 2, '10'), ej('Bíceps curl con banda', 2, '12'), ej('Remo', 2, '10')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Plancha con arrastre', 2, '10'), ej('Tríceps alto en TRX a un brazo', 2, '8'), ej('Ab wheel', 2, '8')]),
      circuito(5, 'HIIT', [ej('Burpees', 4, '6'), ej('Sentadilla con salto', 4, '8'), ej('Bear crawl', 4, '8m')]),
    ]),
    rutinaCasa('#C18', 'Casa Pull J — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Zancada reversa con chop diagonal', 2, '10'), ej('Plié squat', 2, '15'), ej('Split squat pulses', 2, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Hip thrust a una pierna', 2, '12'), ej('Abducción con pausa', 2, '10'), ej('Dead bug', 2, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 2, '15'), ej('Bíceps curl martillo', 2, '10'), ej('Remo alto en TRX', 2, '12')]),
      circuito(4, 'CORE·TRÍCEPS', [ej('Caminata de maleta', 2, '20m'), ej('Extensión de triceps sobre cabeza', 2, '10'), ej('Espinales con disco', 2, '10')]),
      circuito(5, 'HIIT', [ej('Step-up rápidos alternados', 4, '20'), ej('Lateral step overs', 4, '20'), ej('Saltos laterales', 4, '20')]),
    ]),
  ];
}
...
function createRecoveryRoutines() {
  ...
  return [
    ...
    rutinaRecovery('#R02', 'Recovery 2 · Glúteos y piernas suave', 'Nat', 1, [
      ...
      circuito(2, 'GLÚTEOS', [ej('Hip thrust a una pierna', 3, '10'), ej('Extensión de cadera en 4 puntos', 3, '12')]),
    ...
    rutinaRecovery('#R05', 'Recovery 5 · Integrativa suave', 'Nat', 1, [
      ...
      circuito(2, 'PIERNAS · GLÚTEOS', [ej('Sentadilla corporal', 3, '12'), ej('Hip thrust a una pierna', 3, '10')]),
...
function applyExerciseRenames() {
  const RENAME_MAP = new Map([
    ...
    ['Vuelos laterales en equilibrio con kettlebell', 'Vuelos laterales en equilibrio'],
    ['Flexiones con chaleco', 'Flexiones'],
    ...
    ['Puente de glúteos una pierna', 'Hip thrust a una pierna'],
  ]);
...
function ensureCalendarOverrides() {
  ...
  const schedule = [
    ...
    // August-September — Lean (Mon=Press, Wed=Pull, Fri=Press, Sat=Pull, all CASA)
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-01', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-03', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-05', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-07', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-08', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-10', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-12', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-14', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-15', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-17', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-19', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-21', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-22', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-24', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-26', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-28', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-29', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-08-31', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-02', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-04', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-05', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-07', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-09', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-11', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-12', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-14', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-16', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-18', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-19', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-21', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-23', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-25', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-26', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-28', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-09-30', foco: 'pull' },
    // October — Lean (Mon=Press, Wed=Pull, Fri=Press, Sat=Pull, all CASA)
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-02', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-03', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-05', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-07', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-09', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-10', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-12', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-14', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-16', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-17', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-19', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-21', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-23', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-24', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-26', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-28', foco: 'pull' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-30', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-10-31', foco: 'pull' },
    // August-September — Nat (Mon=Press, Wed=Pull, Fri=Press, Sat=Pull, all CASA)
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-01', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-03', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-05', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-07', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-08', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-10', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-12', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-14', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-15', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-17', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-19', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-21', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-22', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-24', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-26', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-28', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-29', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-08-31', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-02', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-04', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-05', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-07', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-09', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-11', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-12', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-14', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-16', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-18', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-19', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-21', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-23', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-25', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-26', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-28', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-09-30', foco: 'pull' },
    // October — Nat (Mon=Press, Wed=Pull, Fri=Press, Sat=Pull, all CASA)
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-02', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-03', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-05', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-07', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-09', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-10', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-12', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-14', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-16', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-17', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-19', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-21', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-23', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-24', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-26', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-28', foco: 'pull' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-30', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-10-31', foco: 'pull' },
...
function migrateCompoundExercises() {
  ...
  const PATCHES = [
    ...
    ['Casa Press C — Lean', 4, 1, 'Estocada con salto', 'Sentadilla con salto', 3, '10'],
    ['Casa Press C — Lean', 4, 2, 'Mountain climbers', 'Bear crawl', 3, '8m'],
    ['Casa Pull C — Lean', 4, 2, 'Jumping jacks', 'Caminata a plancha', 4, '8'],
    ['Casa Press D — Lean', 4, 0, 'Bear crawl', 'Burpees', 3, '8'],
    ['Casa Press D — Lean', 4, 1, 'Burpees', 'Jumping jacks', 3, '30'],
    ['Casa Press D — Lean', 4, 2, 'Saltos laterales', 'Estocada con salto', 3, '8'],
    ['Casa Pull D — Lean', 4, 1, 'Burpees', 'Bear crawl', 3, '8m'],
    ['Casa Press E — Lean', 4, 1, 'Estocada con salto', 'Mountain climbers', 3, '20'],
    ['Casa Press E — Lean', 4, 2, 'Jumping jacks', 'Caminata a plancha', 3, '8'],
    ['Casa Pull E — Lean', 4, 0, 'Mountain climbers', 'Burpees', 3, '8'],
    ['Casa Pull E — Lean', 4, 1, 'Bear crawl', 'Jumping jacks', 3, '30'],
    ['Casa Pull E — Lean', 4, 2, 'Jumping jacks', 'Estocada con salto', 3, '8'],
    // ── NAT ──
    ...
    ['Casa Pull D — Nat', 1, 1, 'Abducción con pausa', 'Copenhague', 2, '15'],
    ['Casa Pull D — Nat', 1, 2, 'Hip thrust a una pierna', 'Extensión de cadera en 4 puntos', 2, '12'],
    ...
    // HIIT redistribution — Nat
    ['Casa Pull A — Nat', 4, 0, 'Tuck jumps', 'Sentadilla con salto', 3, '8'],
    ['Casa Press B — Nat', 4, 0, 'Estocada con salto', 'Caminata a plancha', 3, '8'],
    ['Casa Press B — Nat', 4, 1, 'Saltos laterales', 'Tuck jumps', 3, '8'],
    ['Casa Press B — Nat', 4, 2, 'Sentadilla con salto', 'Mountain climbers', 3, '15'],
    ['Casa Pull B — Nat', 4, 0, 'Sentadilla con salto', 'Burpees', 3, '6'],
    ['Casa Pull B — Nat', 4, 1, 'Mountain climbers', 'Jumping jacks', 3, '25'],
    ['Casa Pull B — Nat', 4, 2, 'Jumping jacks', 'Estocada con salto', 3, '8'],
    ['Casa Press C — Nat', 4, 0, 'Mountain climbers', 'Saltos laterales', 3, '20'],
    ['Casa Press C — Nat', 4, 1, 'Burpees', 'Sentadilla con salto', 3, '8'],
    ['Casa Press C — Nat', 4, 2, 'Jumping jacks', 'Bear crawl', 3, '8m'],
    ['Casa Pull C — Nat', 4, 0, 'Burpees', 'Mountain climbers', 3, '15'],
    ['Casa Pull C — Nat', 4, 1, 'Estocada con salto', 'Tuck jumps', 3, '8'],
    ['Casa Pull C — Nat', 4, 2, 'Bear crawl', 'Caminata a plancha', 3, '8'],
    ['Casa Press D — Nat', 4, 0, 'Sentadilla con salto', 'Burpees', 3, '6'],
    ['Casa Press D — Nat', 4, 1, 'Saltos laterales', 'Jumping jacks', 3, '25'],
    ['Casa Pull D — Nat', 4, 0, 'Tuck jumps', 'Sentadilla con salto', 3, '8'],
    ['Casa Pull D — Nat', 4, 1, 'Saltos laterales', 'Bear crawl', 3, '8m'],
    ['Casa Pull D — Nat', 4, 2, 'Mountain climbers', 'Saltos laterales', 3, '20'],
    ['Casa Press E — Nat', 4, 0, 'Jumping jacks', 'Tuck jumps', 3, '8'],
    ['Casa Press E — Nat', 4, 2, 'Burpees', 'Caminata a plancha', 3, '8'],
    ['Casa Pull E — Nat', 4, 1, 'Sentadilla con salto', 'Jumping jacks', 3, '25'],
    ['Casa Pull E — Nat', 4, 2, 'Jumping jacks', 'Estocada con salto', 3, '8'],
    ['Casa Press F — Nat', 4, 0, 'Estocada con salto', 'Saltos laterales', 3, '20'],
    ['Casa Press F — Nat', 4, 2, 'Saltos laterales', 'Bear crawl', 3, '8m'],
...
function migrateCasaHiitTo4Series() {
  ...
  let changed = false;
  for (const r of rutinas) {
    if (r.lugar !== 'CASA' || !r.nombre?.startsWith('Casa ')) continue;
    const hiit = r.circuitos?.find(c => c.nombre === 'HIIT');
    if (!hiit) continue;
    for (const ej of (hiit.ejercicios || [])) {
      if (ej.series === 3) {
        ej.series = 4;
        changed = true;
      }
  ...
  if (changed) {
    store.set(store.KEYS.rutinas, rutinas);
    console.log('[Migration] CASA HIIT series updated 3→4');
  }
}
