...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C07', 'Casa Press D — Lean', 'Lean', 'press', 2, [
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Plancha lateral con chaleco', 2, '25s'), ej('Abs complex', 2, '30s'), ej('Bíceps curl en equilibrio', 2, '10')]),
    ...
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      ...
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar', 2, '10'), ej('Fondos en banco con chaleco', 2, '12'), ej('Vuelos laterales en equilibrio con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla goblet', 2, '12'), ej('Plancha lateral con chaleco', 2, '25s'), ej('Squat to press con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C06', 'Casa Pull C — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(4, 'PECHO·TRÍCEPS', [ej('Fondos en banco con chaleco', 2, '12'), ej('Flexiones diamante', 2, '10'), ej('Extensión de tríceps con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(4, 'PECHO·TRÍCEPS', [ej('Fondos en banco con chaleco', 2, '12'), ej('Flexiones', 2, '12'), ej('Extensión de tríceps con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      ...
      circuito(4, 'CORE·PIERNAS', [ej('Ab wheel', 2, '8'), ej('Plancha con chaleco', 2, '25s'), ej('Empuje de cadera en piso con peso', 2, '15')]),
