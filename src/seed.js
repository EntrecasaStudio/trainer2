...
function createRioRoutines() {
  return [
    ...
    rutinaRio('#002', 'RÍO Pull B — Espalda', 'Lean', 'pull', 1, [
      ...
      circuito(3, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps en TRX', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '12')]),
    ...
    rutinaRio('#003', 'RÍO Pull C — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Zancadas con kettlebell', 3, '10'), ej('Peso muerto a una pierna con kettlebell', 3, '10')]),
    ...
    rutinaRio('#004', 'RÍO Pull D — Espalda', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12')]),
      circuito(4, 'BÍCEPS', [ej('Curl de bíceps con kettlebell', 3, '12'), ej('Curl de bíceps en TRX', 3, '12')]),
    ...
    rutinaRio('#008', 'RÍO Pull H — Espalda', 'Lean', 'pull', 2, [
      circuito(1, 'PECHO·TRÍCEPS', [ej('Flexiones diamante', 3, '10'), ej('Fondos en banco', 3, '12')]),
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Peso muerto a una pierna con kettlebell', 3, '10'), ej('Zancadas con kettlebell', 3, '10')]),
    ...
    rutinaRio('#010', 'RÍO Press B — Pecho', 'Lean', 'press', 2, [
      circuito(1, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaRio('#011', 'RÍO Press C — Pecho', 'Lean', 'press', 1, [
      circuito(1, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '10'), ej('Curl martillo con kettlebell', 3, '10')]),
    ...
    rutinaRio('#013', 'RÍO Press E — Pecho', 'Lean', 'press', 2, [
      circuito(1, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaRio('#014', 'RÍO Press F — Pecho + Hombros', 'Lean', 'press', 1, [
      circuito(1, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '10'), ej('Curl martillo con kettlebell', 3, '10')]),
    ...
    rutinaRio('#019', 'RÍO Pull D — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(2, 'PIERNAS·GLÚTEOS', [ej('Empuje de cadera en piso con peso', 3, '15'), ej('Peso muerto a una pierna con kettlebell', 3, '10')]),
      circuito(3, 'ESPALDA', [ej('TRX row', 3, '15'), ej('Dominadas australianas', 3, '12')]),
...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C01', 'Casa Press A — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet con kettlebell', 3, '12'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Remo con kettlebell', 3, '10')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 3, '10'), ej('Plancha con chaleco', 3, '30s'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C02', 'Casa Press B — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Zancadas con chaleco de peso', 3, '10'), ej('Sentadilla sumo', 3, '12'), ej('Remo con kettlebell', 3, '12')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Abs complex', 3, '30s'), ej('Plancha con elevación alternada', 3, '10'), ej('Curl martillo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C03', 'Casa Press C — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet con kettlebell', 3, '10'), ej('Sentadilla con salto', 3, '8'), ej('Remo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla sumo', 3, '12'), ej('Sentadilla con salto', 3, '8'), ej('Remo con kettlebell', 3, '12')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Plancha lateral con chaleco', 3, '25s'), ej('Abs complex', 3, '30s'), ej('Curl martillo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla búlgara', 3, '10'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Remo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla búlgara', 3, '10'), ej('Peso muerto a una pierna con kettlebell', 3, '10'), ej('Ab wheel', 3, '10')]),
      circuito(2, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12'), ej('Remo con kettlebell', 3, '10')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '12'), ej('Abs complex', 3, '30s')]),
    ...
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Peso muerto a una pierna con kettlebell', 3, '10'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Plancha lateral con chaleco', 3, '20s')]),
      circuito(2, 'ESPALDA', [ej('TRX row', 3, '12'), ej('Remo con kettlebell', 3, '10'), ej('Dominadas australianas', 3, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps con kettlebell', 3, '12'), ej('Banda pull-apart', 3, '20'), ej('Ab wheel', 3, '10')]),
    ...
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'ESPALDA', [ej('TRX power pull', 3, '8'), ej('TRX row', 3, '12'), ej('Remo con kettlebell', 3, '10')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps con kettlebell', 3, '12'), ej('Curl de bíceps en TRX', 3, '10'), ej('Ab wheel', 3, '10')]),
    ...
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla goblet con kettlebell', 3, '12'), ej('Peso muerto a una pierna con kettlebell', 3, '10'), ej('Abs complex', 3, '30s')]),
    ...
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '12'), ej('Plancha con elevación alternada', 3, '10')]),
    ...
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Hip thrust a una pierna', 3, '10'), ej('Sumo squat to calf raise', 3, '12'), ej('Sentadilla goblet con kettlebell', 3, '12')]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Dominadas australianas', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '12')]),
    ...
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Remo con kettlebell', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C06', 'Casa Pull C — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto a una pierna con kettlebell', 3, '10'), ej('Elevated side leg lifts', 3, '12'), ej('Hollow body', 3, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '15'), ej('TRX row', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Ab wheel', 3, '8'), ej('Curl martillo con kettlebell', 3, '12'), ej('Banda pull-apart', 3, '20')]),
    ...
    rutinaCasa('#C07', 'Casa Pull D — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo con kettlebell', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '12')]),
    ...
    rutinaCasa('#C08', 'Casa Pull E — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Remo alto en TRX', 3, '12'), ej('Curl de bíceps con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C09', 'Casa Pull F — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo con kettlebell', 3, '10'), ej('Curl martillo con kettlebell', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha', 3, '30s'), ej('Curl de bíceps en TRX', 3, '10'), ej('Curl de bíceps con kettlebell', 3, '10')]),
...
function ensureCalendarOverrides() {
  ...
  const schedule = [
    ...
    // From May 16: RIO Sat = opposite of Fri CASA
    { usuario: 'Nat', lugar: 'RIO', date: '2026-05-16', foco: 'pull', letraMin: 'C', letraMax: 'F' },
