...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(6, 'HIIT', [ej('Sentadilla con salto con chaleco', 3, '10'), ej('Mountain climbers', 3, '20'), ej('Burpees', 3, '8')]),
    ]),
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'ACTIVACIÓN', [ej('Activación glúteo con loop band', 3, '15'), ej('Cat-cow', 3, '10')]),
    ...
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('Rotación de hombros con banda', 3, '10'), ej('Rotación torácica', 3, '10')]),
      ...
      circuito(6, 'HIIT', [ej('Mountain climbers con chaleco', 3, '20'), ej('Sentadilla con salto con chaleco', 3, '8'), ej('Jumping jacks', 3, '30')]),
    ]),
    ...
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 3, '15'), ej('Hip 90/90 mobility', 3, '8')]),
      ...
      circuito(6, 'HIIT', [ej('Sentadilla con salto con chaleco', 3, '10'), ej('Jumping jacks con chaleco', 3, '30'), ej('Burpees', 3, '8')]),
    ]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Nat', 'Nat', 'press', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('Banda press de pecho', 3, '15'), ej('Rotación torácica', 3, '10')]),
    ...
    rutinaCasa('#C09', 'Casa Pull F — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'ACTIVACIÓN', [ej('TRX face pull', 3, '15'), ej('Rotación torácica', 3, '10')]),
...
function ensureCalendarOverrides() {
  ...
  const schedule = [
    // ── Histórico pre-May-6 (sin cambios) ───────────────────────────────
    // CASA — Lean
    ...
    // ── Desde May 6: alternancia unificada CASA+RIO ─────────────────────
    // Secuencia: Mié(CASA) → Vie(CASA) → Sáb(RIO) → Lun(CASA) → …
    // Empezando con Press el Mié 6/5, alterna cada día de entrenamiento.
    //
    // Lean — May
    { usuario: 'Lean', lugar: 'CASA', date: '2026-05-06', foco: 'press' },
    { usuario: 'Lean', lugar: 'CASA', date: '2026-05-08', foco: 'pull' },
    ...
    // Nat — May
    { usuario: 'Nat', lugar: 'CASA', date: '2026-05-06', foco: 'press' },
    { usuario: 'Nat', lugar: 'CASA', date: '2026-05-08', foco: 'pull' },
    { usuario: 'Nat', lugar: 'RIO',  date: '2026-05-09', foco: 'press', letraMin: 'C', letraMax: 'F' },
