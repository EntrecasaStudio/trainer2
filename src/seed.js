...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C01', 'Casa Press A — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 3, '12'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Remo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C03', 'Casa Press C — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 3, '10'), ej('Sentadilla con salto', 3, '8'), ej('Remo con kettlebell', 3, '10')]),
    ...
    rutinaCasa('#C11', 'Casa Press F — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla sumo', 3, '12'), ej('Peso muerto a una pierna', 3, '10'), ej('Remo con kettlebell', 3, '12')]),
