...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C01', 'Casa Press A — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 3, '12'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Remo', 3, '10')]),
      circuito(2, 'PECHO', [ej('Floor press con kettlebell', 3, '10'), ej('Flexiones con chaleco', 3, '12'), ej('TRX chest press', 3, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell', 3, '10'), ej('Fondos en banco con chaleco', 3, '12'), ej('Vuelos laterales', 3, '12')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 3, '10'), ej('Plancha con chaleco', 3, '30s'), ej('Curl de bíceps', 3, '10')]),
    ...
    rutinaCasa('#C02', 'Casa Press B — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Zancadas con chaleco de peso', 3, '10'), ej('Sentadilla sumo', 3, '12'), ej('Remo', 3, '12')]),
      circuito(2, 'PECHO', [ej('Flexiones explosivas', 3, '8'), ej('TRX chest press', 3, '12'), ej('Floor press con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Arnold press con kettlebell', 3, '10'), ej('Vuelos laterales', 3, '12'), ej('Banda press de pecho', 3, '15')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Abs complex', 3, '30s'), ej('Plancha con elevación alternada', 3, '10'), ej('Curl martillo', 3, '10')]),
    ...
    rutinaCasa('#C03', 'Casa Press C — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 3, '10'), ej('Sentadilla con salto', 3, '8'), ej('Remo', 3, '10')]),
      circuito(2, 'PECHO', [ej('Floor press con kettlebell', 3, '10'), ej('TRX chest press', 3, '12'), ej('Flexiones diamante', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell', 3, '10'), ej('Extensión de tríceps con banda', 3, '15'), ej('Fondos en banco con chaleco', 3, '12')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 3, '10'), ej('Plancha con chaleco', 3, '30s'), ej('Curl de bíceps', 3, '10')]),
      circuito(5, 'HIIT', [ej('Burpees', 3, '8'), ej('Mountain climbers', 3, '20'), ej('Jumping jacks con chaleco', 3, '30')]),
    ]),
    rutinaCasa('#C07', 'Casa Press D — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla sumo', 3, '12'), ej('Sentadilla con salto', 3, '8'), ej('Remo', 3, '12')]),
      circuito(2, 'PECHO', [ej('Flexiones inclinadas', 3, '12'), ej('Flexiones con chaleco', 3, '10'), ej('TRX chest press', 3, '12')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Arnold press con kettlebell', 3, '10'), ej('Tríceps alto en TRX', 3, '12'), ej('Extensión de tríceps con banda', 3, '15')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Plancha lateral con chaleco', 3, '25s'), ej('Abs complex', 3, '30s'), ej('Curl martillo', 3, '10')]),
      circuito(5, 'HIIT', [ej('Bear crawl', 4, '8m'), ej('Burpees', 3, '8'), ej('Jumping jacks con chaleco', 3, '30')]),
    ]),
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla búlgara', 3, '10'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Remo', 3, '10')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 3, '10'), ej('Plancha lateral con chaleco', 3, '25s'), ej('Curl de bíceps', 3, '10')]),
    ...
    rutinaCasa('#C11', 'Casa Press F — Lean', 'Lean', 'press', 1, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla sumo', 3, '12'), ej('Peso muerto a una pierna', 3, '10'), ej('Remo', 3, '12')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Abs complex', 3, '30s'), ej('Plancha con chaleco', 3, '30s'), ej('Curl martillo', 3, '10')]),
      circuito(5, 'HIIT', [ej('Bear crawl', 4, '8m'), ej('Burpees', 3, '8'), ej('Mountain climbers', 3, '20')]),
    ]),

    // ── LEAN PULL ──────────────────────────────────────────
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla búlgara', 3, '10'), ej('Peso muerto a una pierna', 3, '10'), ej('Ab wheel', 3, '10')]),
      circuito(2, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12'), ej('Remo', 3, '10')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl martillo', 3, '12'), ej('Abs complex', 3, '30s')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Floor press con kettlebell', 3, '10'), ej('Fondos en banco', 3, '12'), ej('Flexiones', 3, '12')]),
      circuito(5, 'HIIT', [ej('Bear crawl', 4, '8m'), ej('Sentadilla con salto', 3, '10'), ej('Burpees', 3, '8')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Peso muerto a una pierna', 3, '10'), ej('Zancadas con chaleco de peso', 3, '10'), ej('Plancha lateral con chaleco', 3, '20s')]),
      circuito(2, 'ESPALDA', [ej('TRX row', 3, '12'), ej('Remo', 3, '10'), ej('Dominadas australianas', 3, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps', 3, '12'), ej('Banda pull-apart', 3, '20'), ej('Ab wheel', 3, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Flexiones', 3, '12'), ej('Extensión de tríceps con kettlebell', 3, '10'), ej('Extensión de tríceps con banda', 3, '15')]),
      circuito(5, 'HIIT', [ej('Jumping jacks con chaleco', 3, '30'), ej('Mountain climbers', 3, '20'), ej('Burpees', 3, '8')]),
    ]),
    rutinaCasa('#C06', 'Casa Pull C — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Empuje de cadera', 3, '12'), ej('Sentadilla búlgara', 3, '10'), ej('Plancha estrella con peso', 3, '6')]),
      circuito(2, 'ESPALDA', [ej('Remo', 3, '10'), ej('Dominadas australianas', 3, '12'), ej('TRX row', 3, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Curl martillo', 3, '12'), ej('Ab wheel', 3, '10')]),
    ...
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'ESPALDA', [ej('TRX power pull', 3, '8'), ej('TRX row', 3, '12'), ej('Remo', 3, '10')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl martillo', 3, '12'), ej('Banda pull-apart', 3, '20'), ej('Ab wheel', 3, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Floor press con kettlebell', 3, '10'), ej('Extensión de tríceps con kettlebell', 3, '10'), ej('Fondos en banco con chaleco', 3, '12')]),
    ...
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      circuito(1, 'PIERNAS·CORE', [ej('Sentadilla goblet', 3, '12'), ej('Peso muerto a una pierna', 3, '10'), ej('Abs complex', 3, '30s')]),
      circuito(2, 'ESPALDA', [ej('Dominadas australianas', 3, '12'), ej('Remo', 3, '10'), ej('Remo alto en TRX', 3, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps', 3, '10'), ej('Banda pull-apart', 3, '20'), ej('Plancha estrella con peso', 3, '6')]),
    ...
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      circuito(1, 'PIERNAS·CORE', [ej('Empuje de cadera', 3, '15'), ej('Peso muerto a una pierna', 3, '10'), ej('Dead bug', 3, '12')]),
      circuito(2, 'ESPALDA', [ej('TRX row', 3, '12'), ej('TRX power pull', 3, '8'), ej('Dominadas australianas', 3, '12')]),
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 3, '10'), ej('Banda pull-apart', 3, '20'), ej('Plancha con elevación alternada', 3, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Flexiones', 3, '10'), ej('Extensión de tríceps con kettlebell', 3, '10'), ej('Floor press con kettlebell', 3, '10')]),
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 3, '10'), ej('Jumping jacks con chaleco', 3, '30'), ej('Burpees', 3, '8')]),
    ]),

    // ── NAT PRESS ──────────────────────────────────────────
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Hip thrust a una pierna', 3, '10'), ej('Sumo squat to calf raise', 3, '12'), ej('Sentadilla goblet', 3, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('TRX chest press', 3, '12'), ej('Flexiones inclinadas', 3, '10'), ej('Press militar con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Vuelos laterales', 3, '12'), ej('Fondos en banco', 3, '12'), ej('Extensión de tríceps con banda', 3, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Ab wheel', 3, '8'), ej('Plancha', 3, '25s'), ej('Hip thrust a una pierna', 3, '12')]),
    ...
    rutinaCasa('#C02', 'Casa Press B — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Elevated side leg lifts', 3, '12'), ej('Déficit reverse lunge', 3, '10'), ej('Step up', 3, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('TRX chest press', 3, '12'), ej('Flexiones', 3, '10'), ej('Arnold press con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Fondos en banco', 3, '12'), ej('Extensión de tríceps con banda', 3, '15'), ej('Vuelos laterales', 3, '12')]),
      circuito(4, 'CORE·PIERNAS', [ej('Abs complex', 3, '25s'), ej('Ab wheel', 3, '8'), ej('Standing weighted hip abduction', 3, '15')]),
    ...
    rutinaCasa('#C03', 'Casa Press C — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Step up', 3, '10'), ej('Banded narrow to wide squat', 3, '12'), ej('Glute bridge', 3, '15')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones', 3, '10'), ej('TRX chest press', 3, '12'), ej('Press militar con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Extensión de tríceps con banda', 3, '15'), ej('Fondos en banco', 3, '12'), ej('Vuelos laterales', 3, '12')]),
      circuito(4, 'CORE·PIERNAS', [ej('Ab wheel', 3, '8'), ej('Plancha con elevación alternada', 3, '8'), ej('Plié squat', 3, '12')]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Standing weighted hip abduction', 3, '12'), ej('Glute bridge', 3, '15'), ej('Narrow to wide squat', 3, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones inclinadas', 3, '12'), ej('TRX chest press', 3, '12'), ej('Arnold press con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Extensión de tríceps con banda', 3, '12'), ej('Fondos en banco', 3, '12'), ej('Vuelos laterales', 3, '12')]),
      circuito(4, 'CORE·PIERNAS', [ej('Plancha', 3, '30s'), ej('Dead bug', 3, '10'), ej('Abducción con pausa', 3, '12')]),
    ...
    rutinaCasa('#C09', 'Casa Press E — Nat', 'Nat', 'press', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Banded narrow to wide squat', 3, '12'), ej('Step up', 3, '10'), ej('Plié dips', 3, '15')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones', 3, '12'), ej('TRX chest press', 3, '12'), ej('Press militar con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Vuelos laterales', 3, '15'), ej('Fondos en banco', 3, '12'), ej('Extensión de tríceps con banda', 3, '15')]),
      circuito(4, 'CORE·PIERNAS', [ej('Plancha', 3, '30s'), ej('Ab wheel', 3, '8'), ej('Déficit reverse lunge', 3, '10')]),
    ...
    rutinaCasa('#C10', 'Casa Press F — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Elevated side reaches', 3, '12'), ej('Plié dips', 3, '12'), ej('Hip thrust a una pierna', 3, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones inclinadas', 3, '12'), ej('TRX chest press', 3, '12'), ej('Arnold press con kettlebell', 3, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Fondos en banco', 3, '12'), ej('Extensión de tríceps con banda', 3, '15'), ej('Vuelos laterales', 3, '12')]),
      circuito(4, 'CORE·PIERNAS', [ej('Hollow body', 3, '25s'), ej('Plancha con elevación alternada', 3, '10'), ej('Sumo squat to calf raise', 3, '12')]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Plié dips', 3, '12'), ej('Elevated side reaches', 3, '12'), ej('Split squat pulses', 3, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Hip thrust a una pierna', 3, '12'), ej('Step up', 3, '12'), ej('Ab wheel', 3, '8')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Dominadas australianas', 3, '12'), ej('Curl de bíceps', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha estrella con peso', 3, '6'), ej('Curl de bíceps en TRX', 3, '12'), ej('Banda pull-apart', 3, '20')]),
      circuito(5, 'HIIT', [ej('Jumping jacks', 3, '25'), ej('Mountain climbers', 3, '15'), ej('Burpees', 3, '6')]),
    ]),
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Split squat pulses', 3, '10'), ej('Abducción con pausa', 3, '10'), ej('Elevated side leg lifts', 3, '15')]),
      circuito(2, 'PIERNAS·CORE', [ej('Sumo squat to RDL', 3, '10'), ej('Banded narrow to wide squat', 3, '12'), ej('Plancha con elevación alternada', 3, '8')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Remo', 3, '10'), ej('Curl de bíceps', 3, '10')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Ab wheel', 3, '8'), ej('Dominadas australianas', 3, '10'), ej('Banda pull-apart', 3, '20')]),
    ...
    rutinaCasa('#C06', 'Casa Pull C — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Narrow to wide squat', 3, '12'), ej('Plié squat', 3, '15'), ej('Banded narrow to wide squat', 3, '15')]),
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto a una pierna', 3, '10'), ej('Elevated side leg lifts', 3, '12'), ej('Hollow body', 3, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '15'), ej('TRX row', 3, '12'), ej('Curl de bíceps', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Ab wheel', 3, '8'), ej('Curl martillo', 3, '12'), ej('Banda pull-apart', 3, '20')]),
    ...
    rutinaCasa('#C07', 'Casa Pull D — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Sumo squat to calf raise', 3, '12'), ej('Hip thrust a una pierna', 3, '10'), ej('Déficit reverse lunge', 3, '10')]),
      circuito(2, 'PIERNAS·CORE', [ej('Glute bridge', 3, '15'), ej('Standing weighted hip abduction', 3, '12'), ej('Plancha estrella con peso', 3, '6')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo', 3, '10'), ej('Curl de bíceps', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Elevated side reaches', 3, '10'), ej('Curl de bíceps en TRX', 3, '10'), ej('Dead bug', 3, '10')]),
    ...
    rutinaCasa('#C08', 'Casa Pull E — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Déficit reverse lunge', 3, '10'), ej('Elevated side leg lifts', 3, '12'), ej('Sumo squat to calf raise', 3, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Sentadilla búlgara', 3, '10'), ej('Step up', 3, '12'), ej('Abs complex', 3, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 3, '15'), ej('Remo alto en TRX', 3, '12'), ej('Curl de bíceps', 3, '10')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Ab wheel', 3, '8'), ej('Dominadas australianas', 3, '12'), ej('Banda pull-apart', 3, '20')]),
      circuito(5, 'HIIT', [ej('Jumping jacks', 3, '25'), ej('Burpees', 3, '6'), ej('Mountain climbers', 3, '20')]),
    ]),
    rutinaCasa('#C09', 'Casa Pull F — Nat', 'Nat', 'pull', 2, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Abducción con pausa', 3, '10'), ej('Split squat pulses', 3, '10'), ej('Step up', 3, '12')]),
      circuito(2, 'PIERNAS·CORE', [ej('Elevated side leg lifts', 3, '15'), ej('Plié dips', 3, '12'), ej('Dead bug', 3, '10')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Dominadas australianas', 3, '12'), ej('Remo', 3, '10'), ej('Curl martillo', 3, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha', 3, '30s'), ej('Curl de bíceps en TRX', 3, '10'), ej('Banda pull-apart', 3, '20')]),
