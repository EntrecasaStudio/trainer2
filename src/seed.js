...
function createCasaRoutines() {
  ...
  return [
    ...
    rutinaCasa('#C03', 'Casa Press C — Lean', 'Lean', 'press', 1, [
      ...
      circuito(2, 'PECHO', [ej('Flexiones diamante', 2, '10'), ej('Floor press con kettlebell', 2, '10'), ej('Flexiones con chaleco', 2, '12')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Plancha estrella con peso', 2, '6'), ej('Dead bug', 2, '12'), ej('Curl de bíceps en TRX', 2, '10')]),
    ...
    rutinaCasa('#C07', 'Casa Press D — Lean', 'Lean', 'press', 2, [
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Plancha lateral con chaleco', 2, '25s'), ej('Abs complex', 2, '30s'), ej('Curl de bíceps en equilibrio con kettlebell', 2, '10')]),
      circuito(5, 'HIIT', [ej('Bear crawl', 3, '8m'), ej('Burpees', 3, '8'), ej('Jumping jacks', 3, '30')]),
    ]),
    rutinaCasa('#C10', 'Casa Press E — Lean', 'Lean', 'press', 2, [
      circuito(1, 'PIERNAS·ESPALDA', [ej('Sentadilla goblet', 2, '10'), ej('Step up', 2, '12'), ej('Banda face pull', 2, '15')]),
      ...
      circuito(4, 'CORE·BÍCEPS', [ej('Ab wheel', 2, '10'), ej('Caminata a plancha', 2, '8'), ej('Banda curl biceps', 2, '12')]),
    ...
    rutinaCasa('#C11', 'Casa Press F — Lean', 'Lean', 'press', 1, [
      ...
      circuito(2, 'PECHO', [ej('Flexiones inclinadas', 2, '12'), ej('Banda press de pecho', 2, '15'), ej('Floor press con kettlebell', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Elevaciones de hombro adelante', 2, '12'), ej('Extensión de tríceps con kettlebell', 2, '10'), ej('Vuelos laterales', 2, '12')]),
      circuito(4, 'CORE·BÍCEPS', [ej('Hollow body', 2, '25s'), ej('Plancha con elevación alternada', 2, '10'), ej('Curl martillo', 2, '10')]),
      circuito(5, 'HIIT', [ej('Saltos laterales', 3, '20'), ej('Mountain climbers', 3, '20'), ej('Burpees', 3, '8')]),
    ]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 2, '10'), ej('Curl de bíceps', 2, '12'), ej('Dead bug', 2, '12')]),
    ...
    rutinaCasa('#C05', 'Casa Pull B — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl martillo', 2, '12'), ej('Banda curl biceps', 2, '12'), ej('Pallof press', 2, '10')]),
    ...
    rutinaCasa('#C08', 'Casa Pull D — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(2, 'ESPALDA', [ej('TRX row', 2, '12'), ej('Remo', 2, '10'), ej('Banda pull-apart', 2, '20')]),
    ...
    rutinaCasa('#C09', 'Casa Pull E — Lean', 'Lean', 'pull', 1, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Curl de bíceps en TRX', 2, '10'), ej('Curl de bíceps en equilibrio con kettlebell', 2, '10'), ej('Plancha estrella con peso', 2, '6')]),
    ...
    rutinaCasa('#C12', 'Casa Pull F — Lean', 'Lean', 'pull', 2, [
      ...
      circuito(3, 'BÍCEPS·CORE', [ej('Banda curl biceps', 2, '12'), ej('Curl martillo', 2, '12'), ej('Pallof press', 2, '10')]),
      circuito(4, 'PECHO·TRÍCEPS', [ej('Flexiones inclinadas', 2, '12'), ej('Tríceps alto en TRX', 2, '12'), ej('Banda triceps pushdown', 2, '15')]),
      circuito(5, 'HIIT', [ej('Burpees', 3, '8'), ej('Tuck jumps', 3, '8'), ej('Estocada con salto', 3, '8')]),
    ]),
    ...
    rutinaCasa('#C01', 'Casa Press A — Nat', 'Nat', 'press', 1, [
      ...
      circuito(2, 'PECHO·HOMBROS', [ej('Floor press con kettlebell', 2, '10'), ej('Flexiones inclinadas', 2, '10'), ej('Press militar con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C03', 'Casa Press C — Nat', 'Nat', 'press', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Plié squat', 2, '15'), ej('Banded narrow to wide squat', 2, '12'), ej('Sentadilla sumo', 2, '12')]),
      circuito(2, 'PECHO·HOMBROS', [ej('Banda press de pecho', 2, '15'), ej('Floor press con kettlebell', 2, '10'), ej('Vuelos laterales en equilibrio con kettlebell', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Press militar con kettlebell', 2, '10'), ej('Fondos en banco', 2, '12'), ej('Extensión de tríceps con banda', 2, '15')]),
    ...
    rutinaCasa('#C09', 'Casa Press E — Nat', 'Nat', 'press', 2, [
      ...
      circuito(2, 'PECHO·HOMBROS', [ej('Flexiones', 2, '12'), ej('Banda press de pecho', 2, '15'), ej('Press militar con kettlebell', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Vuelos laterales', 2, '12'), ej('Fondos en banco', 2, '12'), ej('Extensión de tríceps con banda', 2, '15')]),
    ...
    rutinaCasa('#C10', 'Casa Press F — Nat', 'Nat', 'press', 1, [
      ...
      circuito(2, 'PECHO·HOMBROS', [ej('TRX archer press', 2, '10'), ej('Flexiones', 2, '10'), ej('Arnold press con kettlebell', 2, '10')]),
      circuito(3, 'HOMBROS·TRÍCEPS', [ej('Elevaciones de hombro adelante', 2, '12'), ej('Extensión de tríceps con kettlebell', 2, '10'), ej('Banda triceps pushdown', 2, '15')]),
    ...
    rutinaCasa('#C04', 'Casa Pull A — Nat', 'Nat', 'pull', 1, [
      ...
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha estrella con peso', 2, '6'), ej('Banda pull-apart', 2, '20'), ej('Banda face pull', 2, '15')]),
    ...
    rutinaCasa('#C05', 'Casa Pull B — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Remo', 2, '10'), ej('TRX face pull', 2, '12'), ej('Curl martillo', 2, '10')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Pallof press', 2, '10'), ej('Curl de bíceps en TRX', 2, '10'), ej('Remo alto en TRX', 2, '12')]),
    ...
    rutinaCasa('#C06', 'Casa Pull C — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Narrow to wide squat', 2, '12'), ej('Standing weighted hip abduction', 2, '12'), ej('Step up', 2, '12')]),
      ...
      circuito(4, 'CORE·ACCESORIOS', [ej('Ab wheel', 2, '8'), ej('Banda pull-apart', 2, '20'), ej('Curl de bíceps en equilibrio con kettlebell', 2, '10')]),
    ...
    rutinaCasa('#C07', 'Casa Pull D — Nat', 'Nat', 'pull', 2, [
      ...
      circuito(3, 'ESPALDA·BÍCEPS', [ej('Remo', 2, '10'), ej('Banda face pull', 2, '15'), ej('Curl martillo', 2, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Hollow body', 2, '25s'), ej('Curl de bíceps en TRX', 2, '10'), ej('Remo alto en TRX', 2, '12')]),
      circuito(5, 'HIIT', [ej('Sentadilla con salto', 3, '10'), ej('Mountain climbers', 3, '15'), ej('Jumping jacks', 3, '25')]),
    ]),
    rutinaCasa('#C08', 'Casa Pull E — Nat', 'Nat', 'pull', 1, [
      circuito(1, 'PIERNAS·GLÚTEOS', [ej('Plié dips', 2, '12'), ej('Elevated side reaches', 2, '12'), ej('Sentadilla búlgara con TRX', 2, '10')]),
      circuito(2, 'PIERNAS·CORE', [ej('Peso muerto a una pierna', 2, '10'), ej('Empuje de cadera', 2, '12'), ej('Plancha con chaleco', 2, '25s')]),
      circuito(3, 'ESPALDA·BÍCEPS', [ej('TRX row', 2, '15'), ej('Dominadas australianas', 2, '12'), ej('Curl de bíceps', 2, '12')]),
      circuito(4, 'CORE·ACCESORIOS', [ej('Plancha estrella con peso', 2, '6'), ej('Banda pull-apart', 2, '20'), ej('Banda face pull', 2, '15')]),
      circuito(5, 'HIIT', [ej('Tuck jumps', 3, '8'), ej('Bear crawl', 3, '8m'), ej('Saltos laterales', 3, '20')]),
    ]),
